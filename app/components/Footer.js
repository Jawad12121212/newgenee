...
const Footer = () => {
  return (
    <footer className='h-screen w-full flex flex-col justify-center items-center bg-black max-sm:h-[30vh] text-white gap-[4vw]'>
      ...
      <div className="h-[35vh] w-[60%] max-sm:h-[10vh] border-[1px] border-white flex">
